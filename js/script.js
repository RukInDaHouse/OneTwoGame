const data = [
  ...
  {stmt: "Утверждение 4", desc: "Объяснение утверждения 4"},
  {stmt: "Утверждение 5", desc: "Объяснение утверждения 5"},
  {stmt: "Утверждение 6", desc: "Объяснение утверждения 6"},
  {stmt: "Утверждение 7", desc: "Объяснение утверждения 7"},
  {stmt: "Утверждение 8", desc: "Объяснение утверждения 8"},
  {stmt: "Утверждение 9", desc: "Объяснение утверждения 9"},
];
